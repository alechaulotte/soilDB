...
get_vegplot_transect_from_NASIS_db <-  function(SS = TRUE,
  ...
  LEFT JOIN transectgroundcover_View_1 AS tgc ON tgc.vegtransectiidref = vt.vegtransectid
  ORDER BY s.siteiid;"
