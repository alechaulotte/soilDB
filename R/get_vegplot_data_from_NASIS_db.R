...
get_vegplot_transect_from_NASIS_db <-  function(SS = TRUE,
  ...
  LEFT JOIN transectgroundsurfcover AS tgsc ON tgsc.vegtransectiidref = vt.vegtransectiid
  ORDER BY s.siteiid;"
